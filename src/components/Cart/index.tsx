      ...
      {checkoutOpen ? (
        ...
        <>
          <motion.div
            ...
            className={`w-full h-screen md:w-[400px] bg-primary/95 md:bg-primary/90 md:backdrop-blur-xl flex flex-col z-[101] drop-shadow-2xl fixed top-0 right-0 border-l border-white/5 shadow-glass`}
          >
            <CarttHeader />
